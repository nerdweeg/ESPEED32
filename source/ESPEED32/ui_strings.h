...
extern const char* DISPLAY_MENU_NAMES[][8];
extern const char* STEPS_MENU_NAMES[][4];
...
extern const char* DISPLAY_MENU_NAMES_PASCAL[][8];
extern const char* STEPS_MENU_NAMES_PASCAL[][4];
